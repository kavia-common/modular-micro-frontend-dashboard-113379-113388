...
2. Start the development server (runs at [http://localhost:3002](http://localhost:3002)):
...
- Exposes the main `App` component as `explorer/App` via Module Federation for remote consumption.
- Remote entry available at: `http://localhost:3002/remoteEntry.js`
